...
<script type="text/javascript" src="js/table/ui-bootstrap-tpls.min.js"></script>
...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" >
		<div class="container">
			<a class="navbar-brand" href="#" id='nav_title'></a>
...
<script>
$(function(){
	var who = getQueryString("keyword");
	
	document.getElementById("nav_title").innerHTML='★ '+who+' ★';
	if(checkCookie()){
...
function logout(){
	delCookie("username")
	var parm = getQueryString("keyword");
	var url = "uper.jsp?keyword="+parm;
	top.location = url;
	return false;
}
</script>
