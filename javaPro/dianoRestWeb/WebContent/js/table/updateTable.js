	...
	$("#tableID").bootstrapTable({
		...
		columns:[{
			...
			formatter:function(value,row,index){
					var uper = '<a href="#" mce_href="#" onclick="file_uper(\''+row.song_uper+'\')">'+row.song_uper+'</a> ';
					return uper;
			}
//		},{
//			field:'song_len',
...
function file_uper(uper){
	var url = "uper.jsp?keyword="+ uper;
