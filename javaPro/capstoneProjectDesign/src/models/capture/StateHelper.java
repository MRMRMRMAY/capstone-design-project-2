...
public class StateHelper implements javax.media.ControllerListener {
	...
	/**
	 * * To judge whether the processor is configured. * Configure the processor
	 * in the given time which is limited * by the timeOutMillis.Once a
	 * Processor is Configured, you * can set its output format and TrackControl
	 * options.
	 */
